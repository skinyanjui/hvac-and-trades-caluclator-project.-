...
// Content completeness: every field hinted, every tool referenced, every link and glossary target resolvable.
{
  ...
  const structuralIds = new Set(['app', 'main', 'nav', 'print', 'reset', 'result', 'error', 'calc-form', 'calculator-search', 'header-search', 'mobile-calc', 'mobile-results', 'method-panel', 'share']);
